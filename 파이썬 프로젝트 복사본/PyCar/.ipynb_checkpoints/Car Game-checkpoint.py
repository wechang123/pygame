...
class Car:
    image_car= [ "RC1.png", "RC2.png","RC3.png","RC4.png","RC5.png", \
                     "RC6.png","RC7.png","RC8.png","RC9.png","RC10.png", \
                     "RC11.png","RC12.png","RC13.png","RC14.png","RC15.png", \
                     "RC16.png","RC17.png","RC18.png","RC19.png","RC10.png"  ] #자동차 종류
...
def draw_main_manu():
    ...
    text_start = font_30.render("Press Space key to strat", True, RED)
